# -*- coding: utf-8 -*-
#
# gridDataFormats documentation build configuration file, created by
...
release = __import__("gridData").__version__
...
man_pages = [
    ("index", "griddataformats", "gridDataFormats Documentation", authors.split(), 1)
]
...
texinfo_documents = [
    (
        ...
        authors,
        "gridDataFormats",
        "Grid structure for regular data together with common format readers.",
        "Miscellaneous",
    ),
]

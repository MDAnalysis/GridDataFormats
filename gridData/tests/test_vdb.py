...
class TestVDBWrite:
    ...
    def test_vdb_field_direct(self, tmpdir):
        ...
        vdb_field = gridData.OpenVDB.OpenVDBField(data, origin=[0,0,0], delta=[1,1,1], name='direct_test')
    ...
    def test_write_vdb_with_delta_matrix(self, tmpdir):
        ...
        vdb_field = gridData.OpenVDB.OpenVDBField(data, origin=[0,0,0], delta=delta, name='matrix_delta')
